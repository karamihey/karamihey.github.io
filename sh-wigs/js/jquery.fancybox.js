	...
	$.extend(F, {
		...
		update: function (e) {
			...
			didUpdate = setTimeout(function() {
				...
				if(current.zoom === true)
				{
					var img_obj = $('.fancybox-inner').find('.zoomToggle').removeClass('zoomDisabled zoomToggleOn zoomToggleOff');
					//Size toggle button
					if (current.canShrink && !current.canExpand) {
						img_obj.addClass('zoomToggleOff');
					} else if (!current.canShrink && current.canExpand) { 
						img_obj.addClass('zoomToggleOn');
					} else {
						img_obj.addClass('zoomDisabled');
					}
				}
		...
		_afterLoad: function () {
			...
			if(current.zoom === true)
			{
				var img_obj = $('.fancybox-inner');
				img_obj.find('img').wrap("<a href='javascript:;' class='zoomToggle'>");
				img_obj.find('.zoomToggle').click( F.toggle );
			}
